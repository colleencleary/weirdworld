...
INSERT INTO attractions (name, description, submitted_by, image, city, country, website, tags, rating) VALUES ('Coney Island', 'Freakshows and boardwalks and bars and mermaids and famous hotdogs!', 'Brooklyn Bob', 'https://www.coneyisland.com/sites/default/files/styles/large/public/mariebanner17%20%281%29.jpg?itok=f59CsYDi', 'New York City', 'United States', 'https://www.coneyisland.com/', '{1,2,3}', '4.5');

INSERT INTO attractions (name, description, submitted_by, image, city, country, website, tags, rating) VALUES ('The Mutter Museum', 'medical curiosities', 'Philly Phil','https://orion-uploads.openroadmedia.com/lg_0c126a1eb90f-mutter-museum_featured.jpg', 'Philadelphia', 'United States', 'http://muttermuseum.org/about/', '{4,5,6}', '4.5');
